            ...
            <form action="/dashboard/cashier/{{ $transaksi->id }}" method="post">
                ...
                @if($nama_menu)
                    <div class="profile-wrapper mb-2">
                        ...
                        <input type="number" class="form-control" name="jumlah" id="jumlah" wire:model="jumlah" wire:change="totalHarga" placeholder="Masukkan Jumlah" autocomplete="off">
                    </div>
                    @error('jumlah')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="input-group profile-wrapper mb-2">
                    ...
                    <input type="number" class="form-control" name="total_harga" id="total_harga" wire:model="total_harga" placeholder="Total Harga" value="{{ $total_harga }}" aria-describedby="basic-addon1" autocomplete="off">
                </div>
                @error('total_harga')
                    <div class="invalid-feedback">
                        {{ $message }}
